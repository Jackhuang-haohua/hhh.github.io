...
var loudlinks = function (e) {
    function t() {
        ...
        r && (r.indexOf("") > 0 ? (e = r.replace(c, "mp3"), t = r.replace(c, "ogg")) : (e = g + r + ".mp3", t = p + r + ".ogg"), l || (l = !0, u.addEventListener("error", function () {
    ...
    if (s.log = s.log || function () {}, s.error = s.error || s.log, !e.createElement("audio").canPlayType) return s.error("Oh man 😩! \nYour browser doesn't support audio awesomeness."),
        function () {};
    s.log("Audio works like a charm 👍");
