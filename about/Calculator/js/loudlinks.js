...
var loudlinks = (function(document) {
  ...
  var audioPlayer = document.createElement('audio'),
      ...
      eventsSet = false,
      typeReg = //gi, // regEx for replacing  in the URLs
  ...
  function playAudio() {
    ...
    if ( audioSrc.indexOf('') > 0 ) {
      // Replace all instances of '' in the data-sound attribute to 'mp3' and 'ogg' respectfully.
      // For example: http://loudlinks.rocks/sounds//magic. becomes http://loudlinks.rocks/sounds/mp3/magic.mp3 and http://loudlinks.rocks/sounds/ogg/magic.ogg
